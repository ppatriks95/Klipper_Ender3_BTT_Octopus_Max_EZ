...
Specifially I´ve choosed https://github.com/utkabobr/klipper/releases/download/prebuilt-v0.12.0/bigtreetech-octopus-max-ez.bin or you can get it here ![Octopus Max binary File](files/bigtreetech-octopus-max-ez.bin)
----
